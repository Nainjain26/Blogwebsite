...
const BlogCard = ({ image, tag, title, date, readTime, id }) => (
    ...
    <section className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="flex justify-center mt-10">
        <button
          ...
          className="px-6 py-2 border border-gray-300 rounded-full text-sm font-medium hover:bg-gray-100 transition"
        >
