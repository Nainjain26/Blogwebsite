...
export default function BlogPage() {
  const [activeId, setActiveId] = useState("post1");
  ...
  return (
    <div className="bg-white min-h-screen font-sans px-3 scroll-smooth">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 flex flex-col lg:flex-row gap-12">
        {/* Sidebar */}
        <aside className="lg:w-1/4 text-sm sticky top-20 h-fit">
            ...
            >
              ...
              {post.image && (
                <img
                  src={post.image}
                  alt="Blog visual"
                  className="object-cover w-full h-[300px] rounded-md transform hover:scale-[1.02] hover:rotate-[1deg] transition-transform duration-500 shadow-md cursor-pointer"
                />
              )}
